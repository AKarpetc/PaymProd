                ...
                if (priceMenuId > 0)
                {
                    if (delicate.Del_id < 0)
                    {
                         ...
                         if (component.Fass > 0)
                         {
                             ...
                             item.TotalPrice = decimal.Round(unitPrice * packageCount, 2, System.MidpointRounding.AwayFromZero);
                         }
                         else
                         {
                             item.TotalPrice = decimal.Round(unitPrice * totalWeight, 2, System.MidpointRounding.AwayFromZero);
                         }
                    }
                    else
                    {
