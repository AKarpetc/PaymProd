...
namespace PaymProdNet9.Tests
{
    ...
    public class ReferenceDataTests : IDisposable
    {
        ...
        public void ProductTypes_CRUD_ShouldWork()
        {
            ...
            int id = _repository.AddProductType(typeName, 10, true);
            ...
            // Delete
            bool deleted = _repository.DeleteProductType(id);
            Assert.True(deleted);
        ...
        {
            // Create
            string name = "Test Measure";
            int id = _repository.AddMeasure(name, 100, "g", 3, 4);
